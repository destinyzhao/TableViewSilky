...
@interface WechatMomentsController ()<UITableViewDelegate,UITableViewDataSource>

@property(nonatomic,strong)UITableView *tableView;

@end

@implementation WechatMomentsController
...
-(UITableView *)tableView{
    if (_tableView==nil) {
        ...
        backgroundImageView.image = [UIImage imageNamed:@"moment_head_bg"];
        _tableView.tableHeaderView = backgroundImageView;
        _tableView.contentInset = UIEdgeInsetsMake(-30, 0, 10, 0);
    }
    return _tableView;
}
